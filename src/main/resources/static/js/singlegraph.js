...
var webkitDep = {
    categories:[{name: "核心词"},       //关系网类别
        {name: "属性组"}],
    nodes:[{category: 0, name: "曹操",symbolSize: 80, value: 5, id: 0},  //展示的节点 //category与关系网类别索引对应 //我的源数据中没有id属性，这里放出来的是目标数据，id是自动生成的
    ...
    links:[{source: 0, target: 1, value: 20},    //节点之间连接 //source起始节点，0表示第一个节点  //target目标节点，1表示与索引(id)为1的节点进行连接
